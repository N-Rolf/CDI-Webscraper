...
#ui counter
runningcount += len(aberTitles)

#tkinter
huronHeader = tk.Label(text="Huron Open Projects")
huronHeader.grid(row=runningcount, column=0)
...
#ui counter
runningcount += len(huronTitles)

#tkinter
pierreHeader = tk.Label(text="Pierre Open Projects")
pierreHeader.grid(row=runningcount, column=0)
...
#ui counter
runningcount += len(pierreTitles)

#tkinter
mitchellHeader = tk.Label(text="Mitchell Open Projects")
mitchellHeader.grid(row=runningcount, column=0)
...
#ui counter
runningcount += len(mitchellTitles)

#tkinter
yanktonHeader = tk.Label(text="Yankton Open Projects")
yanktonHeader.grid(row=runningcount, column=0)
...
#ui counter
runningcount += len(yanktonTitles)

#tkinter
spearfishHeader = tk.Label(text="Spearfish Open Projects")
spearfishHeader.grid(row=runningcount, column=0)
...
#ui counter
runningcount += len(spearfishTitles)

#tkinter
vermillionHeader = tk.Label(text="Vermillion Open Projects")
vermillionHeader.grid(row=runningcount, column=0)
...
#ui counter
runningcount += len(vermillionTitles)

#tkinter
madisonHeader = tk.Label(text="Madison Open Projects")
madisonHeader.grid(row=runningcount, column=0)
...
#ui counter
runningcount += len(madisonTitles)

#tkinter
sdgfpHeader = tk.Label(text="SD Game Fish & Parks Open Projects")
sdgfpHeader.grid(row=runningcount, column=0)
